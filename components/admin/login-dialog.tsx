    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Please login again to continue using the application.</DialogDescription>
        </DialogHeader>
        <form className="grid gap-4">
          <div className="grid gap-2">
            <Label htmlFor="email">Email</Label>
            <Input required id="email" type="email" autoComplete="username" placeholder="team@mynaui.com" />
          </div>
          <div className="grid gap-2">
...
lucide-react,
@radix
-ui/react-dialog, @radix-ui/react-slot, class-variance-authority\
\`\`\`\
\
