  ...
  "inline-flex items-center justify-center border font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "success",
        appearance: "light",
        className: "border bg-green-100 text-green-700 dark:text-green-600 dark:bg-green-950/50",
      },
      {
        variant: "warning",
        appearance: "light",
        className: "border bg-yellow-100 text-yellow-700 dark:text-yellow-600 dark:bg-yellow-950/50",
      },
      {
        variant: "info",
        appearance: "light",
        className: "border bg-violet-100 text-violet-700 dark:text-violet-600 dark:bg-violet-950/50",
      },
      {
        variant: "mono",
        appearance: "light",
        className: "bg-zinc-200 dark:bg-zinc-300/10 text-zinc-950 dark:text-zinc-200",
      },
      {
        variant: "destructive",
        appearance: "light",
